...
export default function AdminAds() {
  const ads = [
    { id: 1, brand: "Cheyenne Tattoo Equipments", type: "Banner Lateral", clicks: 1450, status: "Ativo" },
    { id: 2, brand: "Electric Ink", type: "Vídeo Patrocinado (Início)", clicks: 890, status: "Pausado" },
  ];
